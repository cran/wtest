...
#' Parameters calculation for adjustment of W-test for gene-methylation interaction analysis
#'
...
#' @param n.pair a numeric value, the number of SNP-CpG pairs to use in bootstrapping. Default is the minumn value of total number of pairs within a genome distance and 1000.
